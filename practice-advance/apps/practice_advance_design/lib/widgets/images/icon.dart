...
class BazarIcon {
  ...
  static Widget Function({Color? color}) icApple = _BazarAppleIcon.new;
  static Widget Function({Color? color}) icGoogle = _BazarGoogleIcon.new;
}
...
class _BazarCartIcon extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => BazarAssetImage(
        path: Assets.images.icCart.path,
        color: color,
      );
}
...
class _BazarProfileIcon extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => BazarAssetImage(
        path: Assets.images.icProfile.path,
        color: color,
      );
}
...
class _BazarSearchIcon extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => Icon(Icons.search, color: color);
}
...
class _BazarNotificationIcon extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => Icon(Icons.notifications, color: color);
}
...
class _BazarAppleIcon extends StatelessWidget {
  const _BazarAppleIcon({this.color});
  final Color? color;

  @override
  Widget build(BuildContext context) => Icon(Icons.apple, color: color);
}

class _BazarGoogleIcon extends StatelessWidget {
  const _BazarGoogleIcon({this.color});
  final Color? color;
